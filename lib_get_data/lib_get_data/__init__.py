...
class StandardExtractor():
    ...
    """
    _datadir_appendonly = os.path.join(_mydir, 'data_appendonly/{name}')
    _datadir = os.path.join(_mydir, 'data/{name}')
    _tempdir = os.path.join(_mydir, 'tmp')
...
class Register():
    def __init__(self, *extractors):
        ...
        self.register(*extractors)
    def register(*extractors):
