# finnhub_swagger_api.DefaultApi
...
------------- | ------------- | ------------- | -------------
 **symbol** | **str**| Company symbol. | 
 **_from** | **date**| From date &lt;code&gt;YYYY-MM-DD&lt;/code&gt;. | [optional] 
...
try:
    # Dividends 2 (Basic)
    api_response = api_instance.stock_basic_dividends(symbol)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->stock_basic_dividends: %s\n" % e)
```
...
# **stock_candles**
> StockCandles stock_candles(symbol, resolution, _from, to)
...
try:
    # Stock Candles
    api_response = api_instance.stock_candles(symbol, resolution, _from, to)
    pprint(api_response)
except ApiException as e:
...
# **stock_nbbo**
> HistoricalNBBO stock_nbbo(symbol, _date, limit, skip)
...
api_instance = finnhub_swagger_api.DefaultApi(finnhub_swagger_api.ApiClient(configuration))
symbol = 'symbol_example' # str | Symbol.
_date = '2013-10-20' # date | Date: 2020-04-02.
limit = 789 # int | Limit number of ticks returned. Maximum value: <code>25000</code>
skip = 789 # int | Number of ticks to skip. Use this parameter to loop through the entire data.

try:
    # Historical NBBO
    api_response = api_instance.stock_nbbo(symbol, _date, limit, skip)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->stock_nbbo: %s\n" % e)
```
...
# **stock_symbols**
> list[StockSymbol] stock_symbols(exchange, mic=mic, security_type=security_type, currency=currency)
...
# create an instance of the API class
api_instance = finnhub_swagger_api.DefaultApi(finnhub_swagger_api.ApiClient(configuration))
exchange = 'exchange_example' # str | Exchange you want to get the list of symbols from. List of exchange codes can be found <a href=\"https://docs.google.com/spreadsheets/d/1I3pBxjfXB056-g_JYf_6o3Rns3BV2kMGG1nCatb91ls/edit?usp=sharing\" target=\"_blank\">here</a>.
mic = 'mic_example' # str | Filter by MIC code. (optional)
security_type = 'security_type_example' # str | Filter by security type used by OpenFigi standard. (optional)
currency = 'currency_example' # str | Filter by currency. (optional)

try:
    # Stock Symbol
    api_response = api_instance.stock_symbols(exchange, mic=mic, security_type=security_type, currency=currency)
    pprint(api_response)
except ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **exchange** | **str**| Exchange you want to get the list of symbols from. List of exchange codes can be found &lt;a href&#x3D;\&quot;https://docs.google.com/spreadsheets/d/1I3pBxjfXB056-g_JYf_6o3Rns3BV2kMGG1nCatb91ls/edit?usp&#x3D;sharing\&quot; target&#x3D;\&quot;_blank\&quot;&gt;here&lt;/a&gt;. | 
 **mic** | **str**| Filter by MIC code. | [optional] 
 **security_type** | **str**| Filter by security type used by OpenFigi standard. | [optional] 
...
# **stock_tick**
> TickData stock_tick(symbol, _date, limit, skip)
...
try:
    # Tick Data
    api_response = api_instance.stock_tick(symbol, _date, limit, skip)
    pprint(api_response)
except ApiException as e:
...
try:
    # Supply Chain Relationships
    api_response = api_instance.supply_chain_relationships(symbol)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->supply_chain_relationships: %s\n" % e)
```
...
# create an instance of the API class
api_instance = finnhub_swagger_api.DefaultApi(finnhub_swagger_api.ApiClient(configuration))
q = 'q_example' # str | Query text can be symbol, name, isin, or cusip.

try:
    # Symbol Lookup
    api_response = api_instance.symbol_search(q)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->symbol_search: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **q** | **str**| Query text can be symbol, name, isin, or cusip. | 
...
# **technical_indicator**
> TechnicalIndicator technical_indicator(symbol, resolution, _from, to, indicator, indicator_fields=indicator_fields)
...
indicator_fields = finnhub_swagger_api.IndicatorFields() # IndicatorFields | Check out <a href=\"https://docs.google.com/spreadsheets/d/1ylUvKHVYN2E87WdwIza8ROaCpd48ggEl1k5i5SgA29k/edit?usp=sharing\" target=\"_blank\">this page</a> to see which indicators and params are supported. (optional)
 ...
 **indicator_fields** | [**IndicatorFields**](IndicatorFields.md)| Check out &lt;a href&#x3D;\&quot;https://docs.google.com/spreadsheets/d/1ylUvKHVYN2E87WdwIza8ROaCpd48ggEl1k5i5SgA29k/edit?usp&#x3D;sharing\&quot; target&#x3D;\&quot;_blank\&quot;&gt;this page&lt;/a&gt; to see which indicators and params are supported. | [optional] 
