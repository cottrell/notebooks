...
class EconomicEvent(object):
    ...
    def __init__(self, actual=None, prev=None, country=None, unit=None, estimate=None, event=None, impact=None, time=None, _configuration=None):  # noqa: E501
        """EconomicEvent - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EconomicEvent, dict):
